...
public static function MostrarTodosLosAlumnosDB()
{
    ...
    foreach($alumnos as $alumno)
    {
        echo "<br>ID: ",$alumno->ID;
        echo "<br>DNI: ",$alumno->DNI;
        echo "<br>Legajo: ",$alumno->Legajo;
        echo "<br>Nombre: ",$alumno->Nombre;
        echo "<br>Edad: ",$alumno->Edad;
        echo "<br>";
    }
}

public static function BuscarAlumno($_DELETE)
{
}

public function BorrarAlumnoDB()
{
       $objetoAccesoDato = AccesoDatos::dameUnObjetoAcceso(); 
